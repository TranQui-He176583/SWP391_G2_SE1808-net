...
<html lang="en">
  ...
  <ul class="pagination justify-content-center" id="pagination">
    <li class="page-item ${tag2 == 1 ? 'disabled' : ''}">
      <a class="page-link" href="contactDESC?index2=${tag2 - 1}">Previous</a>
    </li>
    <c:forEach begin="1" end="${mPage2}" var="i">
      <li class="page-item ${tag2 == i ? 'active' : ''}">
        <a class="page-link" href="contactDESC?index2=${i}">${i}</a>
      </li>
    </c:forEach>
    <li class="page-item ${tag2 == mPage2 ? 'disabled' : ''}">
      <a class="page-link" href="contactDESC?index2=${tag2 + 1}">Next</a>
    </li>
  </ul>
</div>
