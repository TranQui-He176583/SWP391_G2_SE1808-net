                            ...
                            <div class="row">
                                <div class="col-xl-7 col-lg-9 col-md-8 col-sm-9">
                                    <div class="hero__caption">
                                        ...
                                        <a href="from.html" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.8s">Tham gia</a>
                                    </div>
                                </div>
                            </div>
                        </div>          
                            ...
                            <div class="row">
                                <div class="col-xl-7 col-lg-9 col-md-8 col-sm-9">
                                    <div class="hero__caption">
                                        ...
                                        <a href="from.html" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.8s">Join</a>
                                    </div>
                                </div>
                            </div>
                        </div>          
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-12">
                            <!-- about-img -->
                            <div class="about-img ">
                                <img src="assets/img/gallery/logoteak.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12">
                            <div class="about-caption">
                                ...
                                <div class="section-tittle section-tittle3 mb-35">
                                    <span>CLB Teakwondo</span>
                                    <h2 style="font:inherit; font-size:25px">Câu lạc bộ Taekwondo FPT University là nơi tạo ra không khí đầy cảm hứng và năng động, nơi mà sinh viên không chỉ rèn luyện kỹ năng võ thuật mà còn tạo ra mối quan hệ gắn kết và sự tự tin vững chắc.</h2>
                                </div>
                                <a href="from.html" class="btn">Tham gia</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-11 col-sm-11">
                            ...
                            <div class="about-img2">
                                <img src="assets/img/gallery/fptstrw.jpg" alt="">
                                ...
                                <div class="h1-testimonial-active">
                                    ...
                                    <div class="single-testimonial">
                                        <div class="testimonial-caption">
                                            ...
                                            <div class="rattiong-caption">
                                                <span>Tran Dinh Qui<span>Truong CLB</span> </span>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Single Testimonial -->
                                    <div class="single-testimonial">
                                        <div class="testimonial-caption">
                                            ...
                                            <div class="rattiong-caption">
                                                <span>Qui Tran<span>Leader</span> </span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
