...
<html lang="en">
  ...
  <ul class="pagination justify-content-center" id="pagination">
    <li class="page-item ${tag1 == 1 ? 'disabled' : ''}">
      <a class="page-link" href="contactASC?index1=${tag1 - 1}">Previous</a>
    </li>
    <c:forEach begin="1" end="${mPage1}" var="i">
      <li class="page-item ${tag1 == i ? 'active' : ''}">
        <a class="page-link" href="contactASC?index1=${i}">${i}</a>
      </li>
    </c:forEach>
    <li class="page-item ${tag1 == mPage1 ? 'disabled' : ''}">
      <a class="page-link" href="contactASC?index1=${tag1 + 1}">Next</a>
    </li>
  </ul>
</div>
