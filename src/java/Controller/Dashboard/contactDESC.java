 ...
 * @author pc
 */
@WebServlet(name="contactDESC", urlPatterns={"/contactDESC"})
public class contactDESC extends HttpServlet {
    ...
    int maxPage2 = (count / 5) + (count % 5 != 0 ? 1 : 0);
    List<Contact> list = countdao.SortContactByNameDESC(index2);
