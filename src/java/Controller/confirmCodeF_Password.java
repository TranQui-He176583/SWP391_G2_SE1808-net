 ...
 * @author quyka
 */
@WebServlet(name="confirmCodeF_Password", urlPatterns={"/confirmCodeF_Password"})
public class confirmCodeF_Password extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet confirmCodeF_Password</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet confirmCodeF_Password at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
